/**********************
  ...
  See e.g. https://www.tutorialspoint.com/fletcher-s-checksum
**********************/
...
/**
  \fn uint16_t update_checksum_Fletcher16(uint16_t Chk, uint8_t Data)
...
} // update_checksum_Fletcher16()


/**
  \fn uint16_t calculate_checksum_Fletcher16(const uint32_t AddrStart, const uint32_t AddrEnd)
